...
* @author: Nathan Lentz
* 01.12.17
* Description: getInfo practices accessing system
* calls to get information about the current user. 
* Included is user login name, user ID, groupID, 
* hostname, a user specified password file, and 
* the first 5 entries of the /etc/passwd file
*************************************************/
